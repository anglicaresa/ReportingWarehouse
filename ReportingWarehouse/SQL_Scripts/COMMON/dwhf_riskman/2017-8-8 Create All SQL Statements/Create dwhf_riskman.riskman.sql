...
-- --------------------------------------------------
-- Date Created: 08/08/2017 12:03:40
-- Generated from EDMX file: \\anglicare-sa.org.au\files\frank.wang\My Documents\Source\ReportingWarehouse\ReportingWarehouse\models\dwhf\riskman\riskman.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[riskman].[fk_incident_action_fact_action_dim]', 'F') IS NOT NULL
    ALTER TABLE [riskman].[incident_action_fact] DROP CONSTRAINT [fk_incident_action_fact_action_dim];
GO
IF OBJECT_ID(N'[riskman].[fk_incident_action_fact_incident_fact]', 'F') IS NOT NULL
    ALTER TABLE [riskman].[incident_action_fact] DROP CONSTRAINT [fk_incident_action_fact_incident_fact];
GO
IF OBJECT_ID(N'[riskman].[fk_incident_fact_closed_date_key]', 'F') IS NOT NULL
    ALTER TABLE [riskman].[incident_fact] DROP CONSTRAINT [fk_incident_fact_closed_date_key];
GO
IF OBJECT_ID(N'[riskman].[fk_incident_fact_deleted_date_key]', 'F') IS NOT NULL
    ALTER TABLE [riskman].[incident_fact] DROP CONSTRAINT [fk_incident_fact_deleted_date_key];
GO
IF OBJECT_ID(N'[riskman].[fk_incident_fact_employee_key]', 'F') IS NOT NULL
    ALTER TABLE [riskman].[incident_history_fact] DROP CONSTRAINT [fk_incident_fact_employee_key];
GO
IF OBJECT_ID(N'[riskman].[fk_incident_fact_incident_date_key]', 'F') IS NOT NULL
    ALTER TABLE [riskman].[incident_fact] DROP CONSTRAINT [fk_incident_fact_incident_date_key];
GO
IF OBJECT_ID(N'[riskman].[fk_incident_fact_incident_key]', 'F') IS NOT NULL
    ALTER TABLE [riskman].[incident_history_fact] DROP CONSTRAINT [fk_incident_fact_incident_key];
GO
IF OBJECT_ID(N'[riskman].[fk_incident_fact_investigation_completed_date_key]', 'F') IS NOT NULL
    ALTER TABLE [riskman].[incident_fact] DROP CONSTRAINT [fk_incident_fact_investigation_completed_date_key];
GO
IF OBJECT_ID(N'[riskman].[fk_incident_fact_investigation_initiated_date_key]', 'F') IS NOT NULL
    ALTER TABLE [riskman].[incident_fact] DROP CONSTRAINT [fk_incident_fact_investigation_initiated_date_key];
GO
IF OBJECT_ID(N'[riskman].[fk_incident_fact_manager_key]', 'F') IS NOT NULL
    ALTER TABLE [riskman].[incident_history_fact] DROP CONSTRAINT [fk_incident_fact_manager_key];
GO
IF OBJECT_ID(N'[riskman].[fk_incident_fact_notified_date_key]', 'F') IS NOT NULL
    ALTER TABLE [riskman].[incident_fact] DROP CONSTRAINT [fk_incident_fact_notified_date_key];
GO
IF OBJECT_ID(N'[riskman].[fk_incident_fact_person_key]', 'F') IS NOT NULL
    ALTER TABLE [riskman].[incident_fact] DROP CONSTRAINT [fk_incident_fact_person_key];
GO
IF OBJECT_ID(N'[riskman].[fk_incident_fact_portfolio_key]', 'F') IS NOT NULL
    ALTER TABLE [riskman].[incident_fact] DROP CONSTRAINT [fk_incident_fact_portfolio_key];
GO
IF OBJECT_ID(N'[riskman].[fk_incident_fact_program_key]', 'F') IS NOT NULL
    ALTER TABLE [riskman].[incident_fact] DROP CONSTRAINT [fk_incident_fact_program_key];
GO
IF OBJECT_ID(N'[riskman].[fk_incident_fact_service_stream_key]', 'F') IS NOT NULL
    ALTER TABLE [riskman].[incident_fact] DROP CONSTRAINT [fk_incident_fact_service_stream_key];
GO
IF OBJECT_ID(N'[riskman].[fk_incident_type_fact_incident_fact]', 'F') IS NOT NULL
    ALTER TABLE [riskman].[incident_type_fact] DROP CONSTRAINT [fk_incident_type_fact_incident_fact];
GO
IF OBJECT_ID(N'[riskman].[fk_incident_type_fact_incident_type_dim]', 'F') IS NOT NULL
    ALTER TABLE [riskman].[incident_type_fact] DROP CONSTRAINT [fk_incident_type_fact_incident_type_dim];
GO
...
IF OBJECT_ID(N'[riskman].[action_dim]', 'U') IS NOT NULL
    DROP TABLE [riskman].[action_dim];
GO
IF OBJECT_ID(N'[riskman].[date_dim]', 'U') IS NOT NULL
    DROP TABLE [riskman].[date_dim];
GO
IF OBJECT_ID(N'[riskman].[employee_dim]', 'U') IS NOT NULL
    DROP TABLE [riskman].[employee_dim];
GO
IF OBJECT_ID(N'[riskman].[incident_action_fact]', 'U') IS NOT NULL
    DROP TABLE [riskman].[incident_action_fact];
GO
IF OBJECT_ID(N'[riskman].[incident_fact]', 'U') IS NOT NULL
    DROP TABLE [riskman].[incident_fact];
GO
IF OBJECT_ID(N'[riskman].[incident_history_fact]', 'U') IS NOT NULL
    DROP TABLE [riskman].[incident_history_fact];
GO
IF OBJECT_ID(N'[riskman].[incident_type_dim]', 'U') IS NOT NULL
    DROP TABLE [riskman].[incident_type_dim];
GO
IF OBJECT_ID(N'[riskman].[incident_type_fact]', 'U') IS NOT NULL
    DROP TABLE [riskman].[incident_type_fact];
GO
IF OBJECT_ID(N'[riskman].[person_dim]', 'U') IS NOT NULL
    DROP TABLE [riskman].[person_dim];
GO
IF OBJECT_ID(N'[riskman].[portfolio_dim]', 'U') IS NOT NULL
    DROP TABLE [riskman].[portfolio_dim];
GO
IF OBJECT_ID(N'[riskman].[program_dim]', 'U') IS NOT NULL
    DROP TABLE [riskman].[program_dim];
GO
IF OBJECT_ID(N'[riskman].[service_stream_dim]', 'U') IS NOT NULL
    DROP TABLE [riskman].[service_stream_dim];
GO
...
CREATE TABLE [riskman].[action_dim] (
...
CREATE TABLE [riskman].[employee_dim] (
...
CREATE TABLE [riskman].[incident_fact] (
    [incident_key] int  NOT NULL,
    [id] int  NOT NULL,
...
CREATE TABLE [riskman].[incident_type_dim] (
...
CREATE TABLE [riskman].[incident_type_fact] (
    [incident_type_fact_key] int  NOT NULL,
    [incident_key] int  NOT NULL,
    [incident_type_key] int  NOT NULL
);
GO
...
CREATE TABLE [riskman].[portfolio_dim] (
    [portfolio_key] int  NOT NULL,
...
CREATE TABLE [riskman].[program_dim] (
    [program_key] int  NOT NULL,
...
CREATE TABLE [riskman].[service_stream_dim] (
    [service_stream_key] int  NOT NULL,
...
ALTER TABLE [riskman].[incident_fact]
...
ALTER TABLE [riskman].[incident_type_dim]
...
ALTER TABLE [riskman].[incident_type_fact]
...
ALTER TABLE [riskman].[portfolio_dim]
...
ALTER TABLE [riskman].[program_dim]
...
ALTER TABLE [riskman].[service_stream_dim]
...
ON [riskman].[incident_action_fact]
    ([action_key]);
GO
...
ON [riskman].[incident_history_fact]
    ([employee_key]);
GO
...
ADD CONSTRAINT [fk_incident_fact_portfolio_key]
    ...
    REFERENCES [riskman].[portfolio_dim]
        ([portfolio_key])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO
...
ADD CONSTRAINT [fk_incident_fact_program_key]
    ...
    REFERENCES [riskman].[program_dim]
        ([program_key])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO
...
ADD CONSTRAINT [fk_incident_fact_service_stream_key]
    ...
    REFERENCES [riskman].[service_stream_dim]
        ([service_stream_key])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO
...
ADD CONSTRAINT [fk_incident_type_fact_incident_type_dim]
    ...
    REFERENCES [riskman].[incident_type_dim]
        ([incident_type_key])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO
