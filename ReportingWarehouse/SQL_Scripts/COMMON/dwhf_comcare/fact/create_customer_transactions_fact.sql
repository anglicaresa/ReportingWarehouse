create table [comcare].[customer_transactions_fact] (
	[customer_transaction_key] int not null,
...
-- PK
alter table [comcare].[customer_transactions_fact]
...
add constraint [fk_customer_transactions_customer_key]
    ...
    references [comcare].[customer_dim]
        ([customer_key])
...
add constraint [fk_customer_transactions_transaction_type_key]
    ...
    references [comcare].[transaction_type_dim]
...
add constraint [fk_customer_transactions_program_key]
    ...
    references [comcare].[program_dim]
        ([program_key])
    on delete no action on update no action;
go
...
add constraint [fk_customer_transactions_responsible_party_key]
    ...
    references [comcare].[responsible_party_dim]
