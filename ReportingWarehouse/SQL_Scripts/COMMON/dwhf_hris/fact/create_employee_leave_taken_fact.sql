...
create table [hris].[employee_leave_taken_fact] (
    [employee_leave_taken_key] int not null,
...
alter table [hris].[employee_leave_taken_fact]
...
on [hris].[employee_leave_taken_fact]
    ([leave_type_key]);
go
...
-- FK for manager key
alter table [hris].[employee_leave_taken_fact]
add constraint [fk_employee_leave_taken_fact_manager_key]
...
alter table [hris].[employee_leave_taken_fact]
add constraint [fk_employee_leave_taken_fact_manager_position_key]
