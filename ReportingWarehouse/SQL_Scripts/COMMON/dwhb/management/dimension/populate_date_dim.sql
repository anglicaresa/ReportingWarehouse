  ...
  begin
       insert into management.DATE_DIM (date_key,full_date, display_date, year, quarter, quarter_name, month_no, month_name, day_of_month, day_of_week,day_name, is_public_holiday, public_holiday_name, financial_year, fbt_range, pay_period_end,financial_month_no)
	   select @date_key,
