  ...
  begin
       insert into conform.DATE_DIM (date_key,full_date, display_date, year, quarter, quarter_name, month_no, month_name, day_of_month, day_of_week,day_name, is_public_holiday, public_holiday_name, financial_year, fbt_range, pay_period_end,financial_month_no, max_temperature, min_temperature, rainfall, max_wind_speed)
	   select @date_key,
  ...
  -- default row
  insert into conform.date_dim (date_key,full_date, display_date, year, quarter, quarter_name, month_no, month_name, day_of_month, day_of_week,day_name, is_public_holiday, public_holiday_name, financial_year, fbt_range, pay_period_end)
  ...
  update conform.date_dim set is_public_holiday = 'Yes', public_holiday_name = 'New Years Day'  where month_no = 1 and day_of_month = 1
  update conform.date_dim set is_public_holiday = 'Yes', public_holiday_name = 'Australia Day'  where month_no = 1 and day_of_month = 26
  update conform.date_dim set is_public_holiday = 'Yes', public_holiday_name = 'Anzac Day'  where month_no = 4 and day_of_month = 25
  update conform.date_dim set is_public_holiday = 'Yes', public_holiday_name = 'Cconformtmas Eve' where month_no = 12 and day_of_month = 24
  update conform.date_dim set is_public_holiday = 'Yes', public_holiday_name = 'Christmas Day' where month_no = 12 and day_of_month = 25
  update conform.date_dim set is_public_holiday = 'Yes', public_holiday_name = 'New Years Eve' where month_no = 12 and day_of_month = 31

   -- year specific: 2016
  update conform.date_dim set is_public_holiday = 'Yes', public_holiday_name = 'March public holiday' where month_no = 3 and year = 2016 and day_of_month = 14
  update conform.date_dim set is_public_holiday = 'Yes', public_holiday_name = 'Good Friday' where month_no = 3 and year = 2016 and day_of_month = 25
  update conform.date_dim set is_public_holiday = 'Yes', public_holiday_name = 'Easter Saturday' where month_no = 3 and year = 2016 and day_of_month = 26
  update conform.date_dim set is_public_holiday = 'Yes', public_holiday_name = 'Easter Monday' where month_no = 3 and year = 2016 and day_of_month = 28
  update conform.date_dim set is_public_holiday = 'Yes', public_holiday_name = 'Queens Birthday' where month_no = 6 and year = 2016 and day_of_month = 13
