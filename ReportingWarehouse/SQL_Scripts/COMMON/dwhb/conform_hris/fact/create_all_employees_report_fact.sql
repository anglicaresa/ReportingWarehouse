...
create table [conform].[all_employees_report_fact] (
	[all_employees_report_key] int identity(1,1) not null,
...
alter table [conform].[all_employees_report_fact]
...
-- FK manager_key
alter table [conform].[all_employees_report_fact]
add constraint [fk_all_employees_report_fact_manager_key]
...
alter table [conform].[all_employees_report_fact]
add constraint [fk_all_employees_report_fact_date_key]
