...
-- --------------------------------------------------
-- Date Created: 08/10/2017 14:28:27
-- Generated from EDMX file: \\anglicare-sa.org.au\files\frank.wang\My Documents\Source\ReportingWarehouse\ReportingWarehouse\models\dwhb\conform_hris\conform_hris_conceptual.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[conform].[fk_employee_payment_summary_fact_date_key]', 'F') IS NOT NULL
    ALTER TABLE [conform].[employee_payment_summary_fact] DROP CONSTRAINT [fk_employee_payment_summary_fact_date_key];
GO
IF OBJECT_ID(N'[conform].[fk_employee_payment_summary_fact_employee_key]', 'F') IS NOT NULL
    ALTER TABLE [conform].[employee_payment_summary_fact] DROP CONSTRAINT [fk_employee_payment_summary_fact_employee_key];
GO
IF OBJECT_ID(N'[conform].[fk_employee_payment_summary_fact_portfolio_key]', 'F') IS NOT NULL
    ALTER TABLE [conform].[employee_payment_summary_fact] DROP CONSTRAINT [fk_employee_payment_summary_fact_portfolio_key];
GO
IF OBJECT_ID(N'[conform].[fk_employee_payment_summary_fact_position_key]', 'F') IS NOT NULL
    ALTER TABLE [conform].[employee_payment_summary_fact] DROP CONSTRAINT [fk_employee_payment_summary_fact_position_key];
GO
IF OBJECT_ID(N'[conform].[fk_employee_payment_summary_fact_program_key]', 'F') IS NOT NULL
    ALTER TABLE [conform].[employee_payment_summary_fact] DROP CONSTRAINT [fk_employee_payment_summary_fact_program_key];
GO
IF OBJECT_ID(N'[conform].[fk_employee_payment_summary_fact_service_stream_key]', 'F') IS NOT NULL
    ALTER TABLE [conform].[employee_payment_summary_fact] DROP CONSTRAINT [fk_employee_payment_summary_fact_service_stream_key];
GO
IF OBJECT_ID(N'[conform].[employee_payment_summary_fact]', 'U') IS NOT NULL
    DROP TABLE [conform].[employee_payment_summary_fact];
GO

-- Creating table 'employee_payment_summary_fact'
CREATE TABLE [conform].[employee_payment_summary_fact] (
...
ALTER TABLE [conform].[employee_payment_summary_fact]
...
ON [conform].[employee_payment_summary_fact]
    ([pay_period_date_key]);
GO
