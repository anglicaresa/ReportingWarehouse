...
--select * from [management].[table_dim] where table_name = 'vwSF_SkinTear' and [schema] = 'dbo' and [system] = 'riskman'

--table_key	table_name	system	schema	database	server
--649	vwSF_SkinTear	riskman	dbo	Riskman	ted


--select * from [management].[table_dim] where table_name = 'vwSF_SkinTear' and [schema] = 'extract_riskman' and [system] = 'dwh'
...
values 
((select table_key from [management].[table_dim] where table_name = @t_table and [schema] = 'dbo' and [system] = 'riskman'),
'YES', 
