...
-- creating foreign key on [leave_date_key] in table 'employee_leave_booked_fact'
alter table [hris].[employee_leave_booked_fact]
add constraint [fk_date_dimemployee_leave_booked_fact]
...
create index [ix_fk_date_dimemployee_leave_booked_fact]
on [hris].[employee_leave_booked_fact]
    ([leave_date_key]);
go
