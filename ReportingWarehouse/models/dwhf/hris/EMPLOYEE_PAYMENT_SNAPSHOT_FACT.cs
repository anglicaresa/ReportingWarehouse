...
namespace ReportingWarehouse.models.dwhf.hris
{
    ...
    public partial class employee_payment_snapshot_fact
    {
        public int employee_payment_snapshot_key { get; set; }
        public string payment_amount { get; set; }
        public int payment_key { get; set; }
        public int employee_key { get; set; }
        public int payment_month_key { get; set; }
        ...
        public virtual employee_payment_dim employee_payment_dim { get; set; }
