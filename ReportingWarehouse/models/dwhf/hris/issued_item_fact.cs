...
namespace ReportingWarehouse.models.dwhf.hris
{
    ...
    public partial class issued_item_fact
    {
        public int issued_item_key { get; set; }
        public int item_key { get; set; }
        public int issued_date_key { get; set; }
        public int employee_key { get; set; }
        public int returned_date_key { get; set; }
        ...
        public virtual item_dim item_dim { get; set; }
