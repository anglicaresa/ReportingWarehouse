...
namespace ReportingWarehouse.models.dwhf.hris
{
    ...
    public partial class employee_benefit_fact
    {
        public int employee_benefit_key { get; set; }
        public int employee_key { get; set; }
        public int benefit_key { get; set; }
        public int benefit_date_key { get; set; }
        ...
        public virtual employee_benefit_dim employee_benefit_dim { get; set; }
