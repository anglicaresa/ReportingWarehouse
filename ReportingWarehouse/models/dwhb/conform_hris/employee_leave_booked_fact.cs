...
namespace ReportingWarehouse.models.dwhb.conform_hris
{
    ...
    public partial class employee_leave_booked_fact
    {
        public int employee_leave_booked_key { get; set; }
        public int employee_key { get; set; }
        public int booked_date_key { get; set; }
        public int leave_start_date_key { get; set; }
        public int leave_end_date_key { get; set; }
        ...
        public decimal leave_booked { get; set; }
